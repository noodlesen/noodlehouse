            ...
            e(document).ready(function() {
                ...
                if (v.length && v.load(function() {
                    ...
                    if ("" != d || "" == c && "" == l) {
                        ...
                        if (n.css("background-color", "#000000"), n.css("background-image", "url('https://tilda.ws/img/spinner-white.gif')"), n.css("background-size", "auto"), n.attr("data-content-cover-bg", ""), "" != h) var y = !1;
                        else var y = !0;
                        if ("" != u) var b = 1;
                        else var b = "";
                        var x = "";
